...
import os
from re import sub
from subprocess import call as subprocess_call, STDOUT
...
def compute_patch(src, tgt, imgdiff=False):
    ...
    try:
        ...
        try:
            ...
            pass
        if imgdiff:
            p = subprocess_call(["imgdiff", "-z", srcfile, tgtfile, patchfile],
                     stdout=open("/dev/null", "a"),
                     stderr=STDOUT)
        else:
            p = subprocess_call(["bsdiff", srcfile, tgtfile, patchfile])
